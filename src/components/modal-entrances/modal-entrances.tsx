...
export const ModalEntrances: React.FC<ModalPropsType> = ({ isOpen, onClose, title, list, houseNumber }) => {
    const [isActiveElement, setIsActiveElement] = useState<EntrancesType | null>(null)
                    ...
                    <div className={styles['modal']}>
                        <div className={styles['modal-wrapper']}>
                            <div className={styles['modal-header']}>
                                ...
                                <Button onClick={() => onClose()} variant={'small'} className={styles['modal-close-button']}>
                                    <CloseIcon />
                                </Button>
                            </div>
